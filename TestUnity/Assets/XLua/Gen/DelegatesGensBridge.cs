...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public byte[] __Gen_Delegate_Imp0()
		{
		...
		public byte[] __Gen_Delegate_Imp1(byte[] p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public byte[] __Gen_Delegate_Imp2(byte[] p0, byte[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(Login.FDelegate))
			{
			    return new Login.FDelegate(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(Login.FDelegate1))
			{
			    return new Login.FDelegate1(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(Login.FDelegate2))
			{
			    return new Login.FDelegate2(__Gen_Delegate_Imp2);
			}
