...
// source: ./proto/clientproto.sproto
...
namespace ClientSprotoType { 
	...
	public class changemap {
		...
		public class request : SprotoTypeBase {
			...
			private Int64 _mapid; // tag 0
			public Int64 mapid {
				get { return _mapid; }
				set { base.has_field.set_field (0, true); _mapid = value; }
			}
			...
			protected override void decode () {
				...
				while (-1 != (tag = base.deserialize.read_tag ())) {
					switch (tag) {
					case 0:
						this.mapid = base.deserialize.read_integer ();
						break;
					default:
						base.deserialize.read_unknow_data ();
						break;
			...
			public override int encode (SprotoStream stream) {
				...
				if (base.has_field.has_field (0)) {
					base.serialize.write_integer (this.mapid, 0);
				}
	...
	public class enterinstance {
	
		public class request : SprotoTypeBase {
			private static int max_field_count = 1;
			
			
			private Int64 _instanceid; // tag 0
			public Int64 instanceid {
				get { return _instanceid; }
				set { base.has_field.set_field (0, true); _instanceid = value; }
			}
			...
			protected override void decode () {
				...
				while (-1 != (tag = base.deserialize.read_tag ())) {
					switch (tag) {
					case 0:
						this.instanceid = base.deserialize.read_integer ();
						break;
					default:
						base.deserialize.read_unknow_data ();
						break;
			...
			public override int encode (SprotoStream stream) {
				...
				if (base.has_field.has_field (0)) {
					base.serialize.write_integer (this.instanceid, 0);
				}
...
public class ClientProtocol : ProtocolBase {
	...
	private ClientProtocol() {
		...
		Protocol.SetRequest<ClientSprotoType.auth.request> (auth.Tag);

		Protocol.SetProtocol<challenge> (challenge.Tag);
		Protocol.SetRequest<ClientSprotoType.challenge.request> (challenge.Tag);
		Protocol.SetResponse<ClientSprotoType.challenge.response> (challenge.Tag);

		Protocol.SetProtocol<changemap> (changemap.Tag);
		Protocol.SetRequest<ClientSprotoType.changemap.request> (changemap.Tag);
		Protocol.SetResponse<ClientSprotoType.changemap.response> (changemap.Tag);

		Protocol.SetProtocol<charactercreate> (charactercreate.Tag);
		Protocol.SetRequest<ClientSprotoType.charactercreate.request> (charactercreate.Tag);
		Protocol.SetResponse<ClientSprotoType.charactercreate.response> (charactercreate.Tag);

		Protocol.SetProtocol<characterpick> (characterpick.Tag);
		Protocol.SetRequest<ClientSprotoType.characterpick.request> (characterpick.Tag);
		Protocol.SetResponse<ClientSprotoType.characterpick.response> (characterpick.Tag);

		Protocol.SetProtocol<enterinstance> (enterinstance.Tag);
		Protocol.SetRequest<ClientSprotoType.enterinstance.request> (enterinstance.Tag);
		Protocol.SetResponse<ClientSprotoType.enterinstance.response> (enterinstance.Tag);

		Protocol.SetProtocol<getcharacterlist> (getcharacterlist.Tag);
		Protocol.SetResponse<ClientSprotoType.getcharacterlist.response> (getcharacterlist.Tag);

		Protocol.SetProtocol<handshake> (handshake.Tag);
		Protocol.SetRequest<ClientSprotoType.handshake.request> (handshake.Tag);
		Protocol.SetResponse<ClientSprotoType.handshake.response> (handshake.Tag);
		...
		Protocol.SetResponse<ClientSprotoType.mapready.response> (mapready.Tag);

		Protocol.SetProtocol<moveto> (moveto.Tag);
		Protocol.SetRequest<ClientSprotoType.moveto.request> (moveto.Tag);
		Protocol.SetResponse<ClientSprotoType.moveto.response> (moveto.Tag);

		Protocol.SetProtocol<ping> (ping.Tag);
		Protocol.SetRequest<ClientSprotoType.ping.request> (ping.Tag);
		Protocol.SetResponse<ClientSprotoType.ping.response> (ping.Tag);

		Protocol.SetProtocol<quitgame> (quitgame.Tag);
		Protocol.SetResponse<ClientSprotoType.quitgame.response> (quitgame.Tag);
